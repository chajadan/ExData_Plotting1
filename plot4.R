...
if (file.exists("household_power_consumption.txt")) {
	...
	# upperright plot
	plot(data$POSIXlt, data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

	# lowerright plot
	plot(data$POSIXlt, data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
